...
export async function safeCancelOrder(exchange: ExchangeAdapter, symbol: string, order: AsterOrder, onResolved: (orderId: number | string) => void, onUnknown: () => void, onError: (err: unknown) => void): Promise<void> {
   try {
