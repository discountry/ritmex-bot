...
export const LIGHTER_CHAIN_IDS: Record<LighterEnvironment, number> = { mainnet: 304, testnet: 300, staging: 300, dev: 300 };
...
export const LIGHTER_ORDER_TYPE = { LIMIT: 0, MARKET: 1, STOP_LOSS: 2, STOP_LOSS_LIMIT: 3, TAKE_PROFIT: 4, TAKE_PROFIT_LIMIT: 5, TWAP: 6 } as const;

export const LIGHTER_TIME_IN_FORCE = { IMMEDIATE_OR_CANCEL: 0, GOOD_TILL_TIME: 1, POST_ONLY: 2 } as const;

export const LIGHTER_CANCEL_ALL_TIME_IN_FORCE = { IMMEDIATE: 0, SCHEDULED: 1, ABORT: 2 } as const;
...
export type LighterCancelAllTimeInForce = (typeof LIGHTER_CANCEL_ALL_TIME_IN_FORCE)[keyof typeof LIGHTER_CANCEL_ALL_TIME_IN_FORCE];

export const LIGHTER_TX_TYPE = { CREATE_ORDER: 14, CANCEL_ORDER: 15, CANCEL_ALL_ORDERS: 16 } as const;
